...
abstract class BasePresenter extends \App\Modules\Core\BasePresenter
{
    ...
    protected function getNavItems(): array
    {
        ...
        $items[] = new NavItem(
            new PageTitle(null, $this->csen('O nás', 'About Us'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            ':Default:About:',
            [],
            [
        ...
        $items[] = new NavItem(
            new PageTitle(null, $this->csen('Akce', 'Events'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            ':Events:Default:',
        );

        $items[] = new NavItem(
            new PageTitle(null, $this->csen('Seminář', 'FYKOS Competition'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            ':Events:Fykos:',
            [],
            [
                ...
                new NavItem(new PageTitle(null, $this->csen('Jak psát řešení', 'How to Write Solutions')), ':Events:Fykos:TexTutorial'),
                new NavItem(new PageTitle(null, $this->csen('Jak na experimenty', 'How to Do Experiments')), ':Events:Fykos:Experiments')
            ],
        );

        $items[] = new NavItem(
            new PageTitle(null, $this->csen('Zadání', 'Problems'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            ':Default:Problems:',
        );

        $items[] = new NavItem(
            new PageTitle(null, $this->csen('Pořadí', 'Results'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            ':Default:Results:',
        );

        // $items[] = new NavItem(
        //     new PageTitle(null, $this->csen('Archiv úloh', 'Problem Archive'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
        //     ':Default:ProblemsArchive:',
        // );

        $items[] = new NavItem(
            new PageTitle(null, $this->csen('Přihlásit se', 'Sign In'), 'visible-sm-inline glyphicon glyphicon-info-sign'), // TODO
            'https://db.fykos.cz',
        );
        return $items;
    }
