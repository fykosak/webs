...
abstract class BasePresenter extends \App\Modules\Core\BasePresenter
{
    ...
    protected function getNavItems(): array
    {
        ...
        $items[] = new NavItem(':Default:Archive:default', [], _('Archiv'), 'visible-sm-inline glyphicon glyphicon-compressed');
        $items[] = new NavItem(':Default:Organisers:default', [], _('Organizátoři'), 'visible-sm-inline glyphicon glyphicon-compressed');
        $items[] = new NavItem(':Default:Rules:default', [], _('Pravidla'), 'visible-sm-inline glyphicon glyphicon-exclamation-sign');
        ...
        //$items[] = new NavItem(':Archive:Archive:results', [], _('Výsledky'), 'visible-sm-inline glyphicon glyphicon-stats');
        // }
        //}

        // if ($this->yearsService->isRegistrationActive()) {
        //    if (!$this->getUser()->isLoggedIn()) {
        $items[] = new NavItem(':Default:Default:default', [], _('Registrace'), 'visible - sm - inline glyphicon glyphicon-edit');
        //    }
        // }
        return $items;
    }
